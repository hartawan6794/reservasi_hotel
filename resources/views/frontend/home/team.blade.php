...
<div class="team-area-three pt-100 pb-70">
    <div class="container">
        ...
        <div class="team-slider-two owl-carousel owl-theme pt-45">
            ...
            <div class="team-item">
                <a href="javascript:void(0)" style="display: block; position: relative;">
                    <img src="{{ asset($item->image ?? 'upload/no_image.jpg') }}" alt="{{ $item->name }}" style="width: 100%; height: auto; display: block; border-radius: 15px;">
                </a>
                <div class="content">
