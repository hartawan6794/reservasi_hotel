        ...
        <div class="col-lg-12 col-md-12">
            <div class="form-group">
                ...
                <div class="select-box">
                    ...
                    <option value="Tulang Bawang Timur">Tulang Bawang Timur</option>
                    <option value="Tulang Bawang Utara">Tulang Bawang Utara</option>
                    <option value="Tulang Bawang Selatan">Tulang Bawang Selatan</option>
                    </select>
                </div>
            </div>
        </div>
    ...
    <table class="table" style="width: 100%">
      ...
      $discount =($room->discount/100)*$subtotal;  
        @endphp
            ...
            <tr>
                <td><p>Subtotal</p></td>
                <td style="text-align: right"><p>{{ rupiah($subtotal) }}</p></td>
            </tr>
            <tr>
                <td><p>Discount</p></td>
                <td style="text-align:right"> <p>{{ rupiah($discount) }}</p></td>
            </tr>
            <tr>
                <td><p>Total</p></td>
                <td style="text-align:right"> <p>{{ rupiah($subtotal-$discount) }}</p></td>
            </tr>
    </table>
