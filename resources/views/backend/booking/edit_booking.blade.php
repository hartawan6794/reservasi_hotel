              ...
              <div class="table-responsive">
                ...
                <div class="col-md-6" style="float: right">
                    ...
                    <table class="table test_table" style="float: right" border="none">
                        ...
                        <tr>
                            <td>Grand Total</td>
                            <td>{{ rupiah($editData->total_price) }}</td>
                        </tr>
                    </table>
...
<select name="status" id="input7" class="form-select">
    ...
    <option value="1" {{ $editData->status == 1 ?'selected':''}}>Complete </option> 
               ...
               <div class="card-body">
                @if($editData->payment_status == '1')
                    <div class="alert alert-warning">
                        <strong>Notice:</strong> This booking has completed payment and cannot be edited.
                    </div>
                @endif
                <form action="{{ route('update.booking', $editData->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            ...
                            <input type="date" required name="check_in" id="check_in" class="form-control" value="{{ $editData->check_in }}" {{ $editData->payment_status == '1' ? 'disabled' : '' }}>
                        </div>

                        <div class="col-md-12 mb-2">
                            <label for="">CheckOut</label>
                            <input type="date" required name="check_out" id="check_out" class="form-control" value="{{ $editData->check_out }}" {{ $editData->payment_status == '1' ? 'disabled' : '' }}>
                        </div>

                        <div class="col-md-12 mb-2">
                            <label for="">Room</label>
                            <input type="number" required name="number_of_rooms" class="form-control" value="{{ $editData->number_of_rooms }}" {{ $editData->payment_status == '1' ? 'disabled' : '' }}>
                        </div>
     ...
     <label for="">Availability: <span class="text-success availability"></span> </label> 
                        ...
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary" {{ $editData->payment_status == '1' ? 'disabled' : '' }}>Update </button>
